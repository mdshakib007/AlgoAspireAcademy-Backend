...
from apps.gamification.constants import TITLES, ACTIVITY_CHOICES, BADGES, ACHIEVEMENTS
...
class UserAchievement(BaseModel):
    ...
    title = models.CharField(max_length=100, choices=TITLES, default="Merry Beginner")
...
class Badge(BaseModel):
    ...
    badge_type = models.CharField(max_length=100, choices=BADGES)
...
class Achievement(BaseModel):
    ...
    achievement_type = models.CharField(max_length=100, choices=ACHIEVEMENTS)
